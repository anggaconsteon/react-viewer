...
**Retrofit candidate (baked):** — KOSONG, semua selesai. (217 routeProgressHeaderFull = UNUSED/orphan, dibiarin. **218 driverStopCardFull DIREPURPOSE 2026-06-26 → `returnSubmitButton`** buat rbtCta 1084. 229-234,236,237 dihapus; 235 failedReasonGrid keep.)
...
- [x] ReturnVehicle page 1079 (2026-06-23, updated 2026-06-25) — returnHeader(1080, 2 ph G:H) + vehicleCargoSummary(1081, **14 ph G:T** — user redesign +item-join: itemTable/itemKey/nameField/unitField/condField/fullValue/emptyValue) + circulationSummary(1082, **13 ph G:S**, +nameField) + noticeBar(1083, 3 ph G:I, generic 199). **rbtCta(1084) → DIGENERIKIN 2026-06-26** (dulu LITERAL/baked): savesend `updateEventRow vehicle_check rt◼returned` + chain DO_DIALOG "Kendaraan Diserahkan" gak match simple rbtCta(210, nav-only) atau sendButtonGpsWithEvent(192, nambah addToEvent/fakeGpsAllowed/outPositionAllowed) → bikin template DEDICATED **`returnSubmitButton`** dgn REPURPOSE orphan Widget row 218 (`driverStopCardFull`, 0 usage). 7 ph baked-const (type/alignment:center/savesend/delay:5/gpsPosition:2/addToTable:""): `[TEXT][ROUTE][FLAG][UPDATEEVENTROW][DIALOGTITLE][DIALOGTEXT][OKROUTE]`; B1084=returnSubmitButton, D1084 7-level SUBSTITUTE, helper G1084:M1084. Resolved byte-identical.
...
- [x] **REFACTOR COMPLETE** — semua 10 driver page full generic+SUBSTITUTE. Sweep ulang 2026-06-26 (line 999–1100, cek formulaValue per cell): nemu **3 raw literal** (user re-paste antar-sesi, GOTCHA 7) — semua udah difix: **navActionCard 1014** (DriverHome), **taskFeedList 1068** (TaskFeed), **rbtCta 1084** (ReturnVehicle). Sisanya 1008–1098 confirmed VLOOKUP+SUBSTITUTE. Orphan tersisa: cuma 217 `routeProgressHeaderFull` (218 dipake jadi `returnSubmitButton`).
- ✅ **rbtCta 1084 (ReturnVehicle) UDAH generic** (2026-06-26) — template `returnSubmitButton` @ Widget 218 (ex-orphan driverStopCardFull). Lihat done-log ReturnVehicle.
- ✅ **navActionCard 1014 + taskFeedList 1068 UDAH generic** (2026-06-26) — navActionCard: J204 udah cocok shape (11 field, 10 ph G:P [ROUTE][VIDTABLE][TABLE][SEARCH][READY][GATETABLE][GATESEARCH][ICON][ICONREADY][TEXT]); icon/iconReady helper = literal "[ICON]"/"[ICON_READY]". taskFeedList: D1068 punya 2 field EXTRA (`returnGateTable`,`returnGateSearch` antara route↔returnRoute) → **J224 di-EXTEND 16→18 ph** (+[RETURNGATETABLE][RETURNGATESEARCH]), helper G1068:X1068. Single-use dua-duanya. Byte-identical.
