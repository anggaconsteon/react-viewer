...
/* ============================================================
   HOME — list project
   ============================================================ */
export function ScreenHome({ projects, onOpen }) {
...
/* ============================================================
   ...
   ============================================================ */
export function SelfieModal({ title, sub, onDone, onCancel }) {
        ...
        >
          {shot ? (
            <>
              ...
              <div style={{ fontSize: 11.5, color: C.inkSoft }}>Waktu & lokasi ikut terkunci</div>
            </>
          ) : (
            <>
...
export function ScreenDetail({ project, onBack, onAck, onReportArrival, onReportDone }) {
  const p = project;
  const ot = overtimeMins(p);
    ...
    >
      ...
      {selfie && (
        <SelfieModal
          ...
          sub={
            selfie.kind === 'arrival'
              ? 'Bukti kamu tiba di lokasi. Waktu tercatat saat kamu tap, bukan saat terkirim.'
